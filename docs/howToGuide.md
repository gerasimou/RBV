...
## MKDocs Themes
Several **MKDocs Themes** exist: https://mkdocs.github.io/mkdocs-bootswatch/

Download the code from this GitHub repository and place the `src/` folder in the same directory as your Python script:
